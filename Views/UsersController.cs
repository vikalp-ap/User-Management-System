...
namespace User_Management_System.Views
{
    public class UsersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Age,Name,Email")] UsersModel usersModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Age,Name,Email")] UsersModel usersModel)
        {
            if (id != usersModel.Id)
            {
                return NotFound();
